...
router.post('', (request, response, next) => {
    ...
    pool.query(`
    INSERT INTO fournisseurs (nom, description, ferme, archive , tel, horaire) VALUES 
    ($1, $2, $3, $4, $5, $6)
    `, [nom, description, ferme, archive, tel, horaire], (error, result) => {
        if (error) {
...
router.put('/:id', (req, res, next) => {
    ...
    pool.query(`
        ...
        horaire = $6 
        WHERE id = $7
    `, [nom, description, ferme, archive , tel, horaire, parseInt(req.params.id)], (error, result) => {
        if (error) {
