...
// 1. Vérifie si une lettre est une voyelle
...
// 2. Vérifie si un mot possède une voyelle
...
// 3. Prend une chaine de caractères et renvoie un mot composé des voyelles qu'il contient.
...
// 4. Prend une tableau de chaînes de caractères et renvoie uniquement les mots qui possèdent des voyelles
...
// 5. Prend un tableau de chaines de caractères et renvoie un tableau avec les voyelles des mots qui en contenaient.
...
// 6. Vérifie si tous les mots dans un tableau ne contiennent que la même voyelle (dans le mot, pas entre eux)
...
// 7. Renvoie la lettre répétée une fois
...
// 8. Applique une fonction à toutes les lettres d'un mot

function appliqueAuxLettres(fonction, mot){
    
    return mot.split('')        // ["b","o","n","j","o","u","r"].map(doubleLettre)
        .map(fonction)          // ["bb","oo","nn","jj","oo","uu","rr"].join // ATTENTION : ici on fait appel à une autre fonction déjà définie ailleurs (doubleLettre)
        .join("");              // "bboonnjjoouurr"
...
// 9. Applique une fonction à toutes les voyelles d'un mot
