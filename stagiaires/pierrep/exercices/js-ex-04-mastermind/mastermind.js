...
// CORRECTION : pas faire de reload, rappeler une fonction d'intialiser
...
// CORRECTION : changer nom trop universel
...
//CORRECTION : toujours utiliser le triple égal
// gestio nde l'interface : il faut laisser le choix à l'utilisateur de recommencer ou non, pas utiliser location reload
// CORRECTION : me pencher sur le cas qu'il a mis en évidence où quand tout est d'une couleur et que je teste tout d'une couleur, ça bug avec deux noirs et deux blancs
// utiliser une constante pour définir, comme il l'a fait, feedback
...
// CORRECTION DENIS : on égalise pas un body.onload avec une fonction
...
//CORRECTION : séparer les trois lignes suivantes pour simplifier?  créer des fonctions pour alléger
