...
async function createCommentaire(body) {
    ...
    const value = await pool.query(`
        INSERT INTO commentaires (nom, prenom, titre,article_id, commentaire, date_ajout) VALUES ($1, $2, $3, $4, $5, $6)`,
        [nom, prenom, titre, article_id, commentaire, date_ajout])
        .catch(error => {
            console.log(error);
            if (errothrow.code.startsWith('22')){
                 new Error('FORMAT_INVALIDE');
            }
